...
<!--webbot bot="Include" endspan i-checksum="35518" --><!-- #EndEditable --></div>
	<div id="content">
		...
		<h1>Development Kits</h1>
		<p>The following packages contain support files to compile mapserver and gdal by yourself. In order to compile GDAL and MapServer you must also obtain the source packages from the <a href="development.php">development</a>, <a href="stable.php">stable</a> and <a href="release.php">release</a> sections and extract these sources in the SDK root directory. Refer to the readme file in the packages for further build instructions.</p>
		<table>
		<tr><th>Compiler</th><th>Platform</th><th>Downloads</th><th>Date</th></tr>
		<tr><td>MSVC 2008</td><td>win32</td><td><a href="query.html?content=filelist&file=release-1500-dev.zip">release-1500-dev</a></td><td><?php echo GetFileDate("release-1500-dev.zip") ?></td></tr>
		<tr><td>MSVC 2008</td><td>x64</td><td><a href="query.html?content=filelist&file=release-1500-x64-dev.zip">release-1500-x64-dev</a></td><td><?php echo GetFileDate("release-1500-x64-dev.zip") ?></td></tr>
		<tr><td>MSVC 2010</td><td>win32</td><td><a href="query.html?content=filelist&file=release-1600-dev.zip">release-1600-dev</a></td><td><?php echo GetFileDate("release-1600-dev.zip") ?></td></tr>
		<tr><td>MSVC 2010</td><td>x64</td><td><a href="query.html?content=filelist&file=release-1600-x64-dev.zip">release-1600-x64-dev</a></td><td><?php echo GetFileDate("release-1600-x64-dev.zip") ?></td></tr>
		<tr><td>MSVC 2012</td><td>win32</td><td><a href="query.html?content=filelist&file=release-1700-dev.zip">release-1700-dev</a></td><td><?php echo GetFileDate("release-1700-dev.zip") ?></td></tr>
		<tr><td>MSVC 2012</td><td>x64</td><td><a href="query.html?content=filelist&file=release-1700-x64-dev.zip">release-1700-x64-dev</a></td><td><?php echo GetFileDate("release-1700-x64-dev.zip") ?></td></tr>
		<tr><td>MSVC 2013</td><td>win32</td><td><a href="query.html?content=filelist&file=release-1800-dev.zip">release-1800-dev</a></td><td><?php echo GetFileDate("release-1800-dev.zip") ?></td></tr>
		<tr><td>MSVC 2013</td><td>x64</td><td><a href="query.html?content=filelist&file=release-1800-x64-dev.zip">release-1800-x64-dev</a></td><td><?php echo GetFileDate("release-1800-x64-dev.zip") ?></td></tr>
		<tr><td>MSVC 2015</td><td>win32</td><td><a href="query.html?content=filelist&file=release-1900-dev.zip">release-1900-dev</a></td><td><?php echo GetFileDate("release-1900-dev.zip") ?></td></tr>
		<tr><td>MSVC 2015</td><td>x64</td><td><a href="query.html?content=filelist&file=release-1900-x64-dev.zip">release-1900-x64-dev</a></td><td><?php echo GetFileDate("release-1900-x64-dev.zip") ?></td></tr>
		<tr><td>MSVC 2017</td><td>win32</td><td><a href="query.html?content=filelist&file=release-1911-dev.zip">release-1911-dev</a></td><td><?php echo GetFileDate("release-1911-dev.zip") ?></td></tr>
		<tr><td>MSVC 2017</td><td>x64</td><td><a href="query.html?content=filelist&file=release-1911-x64-dev.zip">release-1911-x64-dev</a></td><td><?php echo GetFileDate("release-1911-x64-dev.zip") ?></td></tr>
		<tr><td>MSVC 2017 <sup class="note">new</sup></td><td>win32</td><td><a href="query.html?content=filelist&file=release-1916-dev.zip">release-1916-dev</a></td><td><?php echo GetFileDate("release-1916-dev.zip") ?></td></tr>
